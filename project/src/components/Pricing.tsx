            ...
            >
                ...
                <div className="mb-4">
                  <span
                    className={`text-4xl font-bold ${
                      plan.highlighted && hoveredPro ? "line-through text-red-400" : ""
                    }`}
                  >
                    {plan.price}
                  </span>
              ...
              {plan.highlighted ? (
                <button
                  ...
                  onClick={() =>
                    isSignedIn ? navigate("/free-trial-auth") : alert("Please sign in first")
                  }
                ...
                >
                  {hoveredPro ? "Want Free Plan?" : "Get Started"}
                </button>
              ) : (
                <button
                  className="w-full py-3 px-6 rounded-lg font-medium transition-colors bg-purple-600 text-white hover:bg-purple-700"
                >
                  Get Started
                </button>
              )}
