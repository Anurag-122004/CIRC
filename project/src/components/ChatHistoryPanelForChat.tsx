...
import type { ChatSessionOnlyForChat } from '../types';

interface ChatHistoryPanelProps {
  isOpen: boolean;
  onClose: () => void;
  sessions: ChatSessionOnlyForChat[];
  currentSessionId: string | null;
  onSessionSelect: (session: ChatSessionOnlyForChat) => void;
  isLoading: boolean;
}

const ChatHistoryPanelForChat: React.FC<ChatHistoryPanelProps> = ({
  isOpen,
  onClose,
  sessions,
  currentSessionId,
...
export default ChatHistoryPanelForChat;
